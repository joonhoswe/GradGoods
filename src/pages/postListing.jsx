                ...
                <div className='flex flex-row h-full w-full'>
                    ...
                    <div className='flex flex-col text-3xl font-bold h-full w-full md:w-1/2'>
                        ...
                        <div className="flex flex-col" style={{paddingTop: '30px'}}>
                            ...
                            <div className={`flex items-center justify-center h-72 w-full max-w-lg rounded-lg border-2 border-grey mt-3 relative ${!isEmailValid ? 'cursor-not-allowed' : 'cursor-pointer'}`} style={{width: '500px', paddingTop: '5px'}}>
                                <input
                                ...
                                <div className="flex flex-col items-center justify-center">
                                    ...
                                    <button className={`mt-2 text-blue-500 underline ${!isEmailValid ? 'cursor-not-allowed' : 'cursor-pointer'}`} disabled={!isEmailValid}>
                                        Choose File
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className="mt-4 w-full">
                                {fileNames.map((name, index) => (
                                    <div key={index} className="w-full h-8 flex items-center justify-between rounded-lg bg-gray-200 p-2 mb-2">
                                        ...
                                        <button onClick={() => handleFileDelete(index)} className={`text-red-500 text-sm hover:text-gray-400 transition ease-in-out duration-300 ${!isEmailValid ? 'cursor-not-allowed' : 'cursor-pointer'}`} title='Remove Image' disabled={!isEmailValid}>
                                            x
                                        </button>
                                    </div>
                                ))}
                    ...
                    <div className='flex flex-col h-full w-1/2 space-y-4'>
                        ...
                        <div className="flex flex-col">
                            ...
                            <input 
                                ...
                                className={`p-2 border rounded-lg ${!isEmailValid ? 'cursor-not-allowed' : 'cursor-text'}`}
                                disabled={!isEmailValid} // Disable input if the email is not valid
                            />
                        </div>
